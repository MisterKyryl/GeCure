(() => {
        ...
        if (spollersArray.length > 0) {
            ...
            function setSpollerAction(e) {
                ...
                if (el.closest("[data-spoller]")) {
                    ...
                    if (!spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        if (window.innerWidth < 1400) _slideToggle(spollerTitle.nextElementSibling, spollerSpeed); else spollerTitle.nextElementSibling.hidden = !spollerTitle.nextElementSibling.hidden;
                    }
                    e.preventDefault();
                }
            }
            function hideSpollersBody(spollersBlock) {
                ...
                if (spollerActiveTitle && !spollersBlock.querySelectorAll("._slide").length) {
                    ...
                    if (window.innerWidth < 1400) _slideUp(spollerActiveTitle.nextElementSibling, spollerSpeed); else spollerActiveTitle.nextElementSibling.hidden = true;
                }
            }
            ...
            if (spollersClose.length) document.addEventListener("click", (function(e) {
                ...
                if (!el.closest("[data-spollers]")) spollersClose.forEach((spollerClose => {
                    ...
                    if (window.innerWidth < 1400) _slideUp(spollerClose.nextElementSibling, spollerSpeed); else spollerClose.nextElementSibling.hidden = true;
                }));
            }));
        }
    }
    ...
    function menuInit() {
        if (document.querySelector(".header__button")) document.addEventListener("click", (function(e) {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const tooltips = tippy_esm("[data-tippy-content]", {
            placement: "bottom",
            offset: [ 0, 2 ],
            duration: 400
        });
        const aimElements = document.querySelectorAll(".tipps-aims_2");
        aimElements.forEach((el => {
            const tooltipInstance = tooltips.find((instance => instance.reference === el));
    ...
    function initSliders() {
        ...
        if (document.querySelector(".key__slider")) new swiper_core_Swiper(".key__slider", {
            ...
            parallax: true,
            pagination: {
                el: ".slider-key__swiper-pagination",
                clickable: true,
                type: "bullets"
            },
            on: {}
        });
        if (document.querySelector(".most__slider")) new swiper_core_Swiper(".most__slider", {
            modules: [ Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            parallax: true,
            pagination: {
                el: ".slider-most__swiper-pagination",
                clickable: true,
                type: "bullets"
            },
            on: {}
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const items = document.querySelectorAll(".body-foundation__item");
        const prevButton = document.querySelector(".navigation-foundation__prev");
        const nextButton = document.querySelector(".navigation-foundation__next");
        const disabledClass = "navigation-foundation-disabled";
        let currentIndex = 0;
        if (items.length > 0 && prevButton && nextButton) {
            items.forEach((item => {
                item.addEventListener("mouseenter", (() => {
                    const activeItem = document.querySelector(".body-foundation__item._active");
                    if (activeItem && !item.classList.contains("_active")) {
                        activeItem.classList.remove("_active");
                        activeItem.classList.add("_was-active");
                    }
                    item.classList.add("hover-active");
                }));
                item.addEventListener("mouseleave", (() => {
                    item.classList.remove("hover-active");
                    const wasActiveItem = document.querySelector(".body-foundation__item._was-active");
                    if (wasActiveItem) {
                        wasActiveItem.classList.add("_active");
                        wasActiveItem.classList.remove("_was-active");
                    }
                }));
            }));
            function updateActiveItem(index) {
                items.forEach(((item, i) => {
                    if (i === index) item.classList.add("_active"); else item.classList.remove("_active");
                }));
                if (currentIndex === items.length - 1) nextButton.classList.add(disabledClass); else nextButton.classList.remove(disabledClass);
                if (currentIndex === 0) prevButton.classList.add(disabledClass); else prevButton.classList.remove(disabledClass);
            }
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const items = document.querySelectorAll(".body-customized-gene .slider-hover__item");
        const prevButton = document.querySelector(".navigation-customized-gene__prev");
        const nextButton = document.querySelector(".navigation-customized-gene__next");
        const container = document.querySelector(".body-customized-gene__content");
        const disabledClass = "slider-hover-disabled";
        const translateClass = "slider-hover-translate";
        let currentIndex = 0;
        let currentTranslateX = 0;
        const translateStep = 256;
        const transitionDuration = 400;
        const minWidthForAnimation = 992;
        if (items.length === 0 || !prevButton || !nextButton || !container.classList.contains(translateClass)) return;
        ...
        items.forEach(((item, index) => {
            item.addEventListener("mouseenter", (() => {
                const activeItem = document.querySelector(".body-customized-gene .slider-hover__item._active");
                if (activeItem && !item.classList.contains("_active")) {
                    activeItem.classList.remove("_active");
                    activeItem.classList.add("_was-active");
                }
            ...
            item.addEventListener("mouseleave", (() => {
                item.classList.remove("hover-active");
                const wasActiveItem = document.querySelector(".body-customized-gene .slider-hover__item._was-active");
                if (wasActiveItem) {
                    wasActiveItem.classList.add("_active");
                    wasActiveItem.classList.remove("_was-active");
                }
            ...
            item.addEventListener("click", (() => {
                currentIndex = index;
                updateActiveItem(currentIndex);
                if (container.classList.contains(translateClass) && window.innerWidth > minWidthForAnimation) {
                    currentTranslateX = -currentIndex * translateStep;
                    container.style.transform = `translateX(${currentTranslateX}px)`;
                }
            }));
        }));
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        function toggleScrollUpButton() {
            if (window.scrollY > 100) scrollUpButton.classList.add("show"); else scrollUpButton.classList.remove("show");
        }
